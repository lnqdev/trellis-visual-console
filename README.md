...
当前不包含 Linux、Windows ARM64、macOS Universal、Apple Developer ID、公证、Windows 商业代码签名、自动降级、托盘、多窗口、团队账号、远程访问、云同步和应用内编辑。在线更新仅面向免费受控内测；三平台托管发布需要在标准 Runner 完成构建，真实升级验收按 macOS arm64/x64、Windows x64 矩阵执行。
