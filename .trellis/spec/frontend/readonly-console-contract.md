...
Playwright 至少覆盖：扫描/登记、中文错误、项目切换 URL 清理、焦点进出、SSE 自动刷新、Spec/Task/JSONL、原始 HTML 安全、375/768/1024/1440 无水平滚动、控制台无错误和 API 无未知失败。
...
if (detail.project.id === selectedProjectId && containsSpecFile(detail.snapshot?.specTree ?? [], path)) {
